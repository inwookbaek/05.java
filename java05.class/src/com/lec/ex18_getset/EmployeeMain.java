...
public class EmployeeMain {
	...
	public static void main(String[] args) {
		...
		Employee emp2 = new Employee(1001, "홍길순", new Date(), 20000, 20, true, "950101-2234567");
		Employee emp3 = new Employee(1001, "홍길상", new Date(), 25000, 30, true, "900101-1234567");
		...
		Employee[] employees = {emp1, emp2, emp3, new Employee(), 
				new Employee(1100, "손흥민", new Date(), 10000, 10, true, "991225-1234567")};
