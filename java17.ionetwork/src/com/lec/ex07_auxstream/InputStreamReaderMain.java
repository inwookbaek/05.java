...
/*
	...
	보조스트림이란 다른 스트림과 연결해서 다양한 기능을 제고해 주는 보조 스트림을 말한다. 보조스트림은
	필터(Filter)스트림이라고도 한다. 보조스트림은 그 일부가 FilterInputStream, FilterOutputStream의
	하위 클래스이다. 
	
	보조스트림은 입출력을 수행할 수 없기 때문에 InputStream, FilterInputStream, Reader, FileReader와
	연결해서 입력을 수행할 수 있고 OutputStream, FilterOutputStream, Writer, FileWriter와 연결해서 
	출력을 수행한다.
	...
	4. 프린터 보조스트림 : PrintStream, PritWriter
*/
