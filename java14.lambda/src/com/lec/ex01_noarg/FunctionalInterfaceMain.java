...
/*
	...
	람다식은 익명함수를 생성하기 위한 식으로 객체지형언어보돠 함수지향언어에 가깝다. 자바에 람다식을
	...
	2. 타겟함수와 함수적인터페이스
	   ...
	   메서드를 단독으로 사용할 수 없고 항상 클래스이 멤버로 선언하기 때무에 람다식은 단순히 메서드를 선언
...
// @FunctionalInterface 
// 추상메서드가 한개가 아니기 때문에 FunctionalInterface로 선언할 수 없다. 
