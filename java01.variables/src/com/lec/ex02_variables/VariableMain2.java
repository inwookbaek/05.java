...
public class VariableMain2 {
	...
	public static void main(String[] args) {
		...
		// b1 = -129; // - 128을 벗어난 에러
		// b2 = 128;  // byte타입이 표현할 수 있는 숫자범위를 초과한 에에
		b1 = (byte) -23847923;  // 정수의 기본타입은 int, int를 byte변환
		b2 = (byte) 230498720; // (byte) int타입인 12312을 byte로 강제변환
		System.out.println("b1=" + b1 + ", b2=" + b2);
		System.out.println();
		...
		// 따라서 float로 선언할 경우 long타입처럼 뒤에 F or f로 선언하거나 데이터타입을
		// 변경(형변환)해야 한다.
		...
		// 3) 논리 : boolean(1) : true, fasle, 내부적으로 true=1, false=0의 정수값을 가지고 있다.
		boolean bool1 = true;
		boolean bool2 = false;
