...
public class StringMain {
	...
	public static void main(String[] args) {
		...
		// String(문자열)은 참조(Reference)타입, 문자열은 String이라는 클래스타입이다.
		// 자바에서는 클래스로 선언된 것은 모두 참조타입이다.
		// 자바에서 문자열을 표현할 때는 큰 따옴표로 선언한다.
		// 작은 따옴표는 char타입을 선언할 때 사용한다.
		
		char c1 = 'A';   // 기본타입인 정수타입중 하나인 char타입
		// char c2 = "A";   // 에러: char타입은 한개의 문자(내부적으로 유니코드정수값)만 저정할 수 있다.
		String str1 = "A";
		String str2 = "AAA";
