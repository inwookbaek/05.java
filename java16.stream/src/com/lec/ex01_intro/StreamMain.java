...
/*
	...
	역할을 하는 반복자이지만 1. 람다식으로 처리할 수 있다. 2. 내부반복자를 사용함으로써 병렬처리가 쉽다는 점이다.
	또한, 3. 중간처리, 최종처리작업을 수행한다는 점에서 많은 차이가 있다.
	...
	1. 람다식으로 요소를 처리하는 코드를 제공한다.
	   ...
	   참조를 이용해서 요소처리내뇽을 매개값으로 전달할 수 있다.	
	...
	3. 중간처리와 최종처리를 할 수 있다.
	   ...
	   스트림은 컬렉션의 요소에 중간처리, 최종처리를 수행할 수 있는데 중간처리는 매핑, 필터링, 정렬등의 작업을
	   수행하고 최종처리메서드는 반복, 카운팅, 평균, 합계등의 처리를 말한다.
