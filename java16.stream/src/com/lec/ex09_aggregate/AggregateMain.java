...
/*
	...
	해서는 각각 get(), getAsDouble(), getAsInt(), getAsLong()메서드를 호출하면 된다.
...
public class AggregateMain {
	...
	public static void main(String[] args) {
		...
		System.out.println("2배수중 첫 번째값 = " + Arrays.stream(int_arr).filter(n -> n%2 == 0).findFirst().getAsInt());
		System.out.println();
