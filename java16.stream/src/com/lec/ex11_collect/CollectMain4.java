...
public class CollectMain4 {
	...
	public static void main(String[] args) {
		...
		// 2. 성별로 평균점수구하기(2) - reducing요약
		Map<Student.Gender, Double> by_gender1 
			= list.stream()
		...
		Map<Student.Gender, String> by_gender2
			= list.stream()
			      .collect(Collectors.groupingBy(Student::getGender
