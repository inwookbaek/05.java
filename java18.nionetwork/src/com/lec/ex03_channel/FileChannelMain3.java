...
public class FileChannelMain3 {
	...
	public static void main(String[] args) throws Exception {
		...
		Path from = Paths.get("src/com/lec/ex02_buffer/blackpink.jpg");
		Path to = Paths.get("c:/temp/blackpink.jpg");
		...
		to = Paths.get("c:/temp/blackpink.jpg");
		Files.copy(from, to, StandardCopyOption.REPLACE_EXISTING);
		System.out.println("파일이 성공적으로 복사가 되었습니다!! - copy()메서드 사용하고 복사" );
	}
